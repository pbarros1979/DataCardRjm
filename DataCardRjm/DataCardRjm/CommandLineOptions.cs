...
namespace DataCardRjm
{
    ...
    internal class CommandLineOptions {
		...
		public string cpfCartao = "";
		public string codBarraCartao = "";
        ...
        static public CommandLineOptions CreateFromArguments(string[] args) {
			...
			commandLineOptions.nomeCartao = arguments["no"];
			commandLineOptions.cpfCartao = arguments["cp"];
			commandLineOptions.lojaCliente = arguments["lo"];
			commandLineOptions.dataCliente = arguments["an"];
			commandLineOptions.printerName = arguments["n"];
			commandLineOptions.codBarraCartao = arguments["cb"];
